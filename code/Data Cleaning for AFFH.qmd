...
```{python}
req_cols = ["Total_Population2020", "white_2020", "black_2020", "native_2020", "asian_pi_2020", "hisp_2020", "pct_white_2020", "pct_black_2020", "pct_native_2020", "pct_asian_pi_2020", "pct_hispanic_2020", "pov_idx", "haz_idx", "tcost_idx", "pct_poor_ns", "pct_nonwhite", "hh_pct_white_lt30ami", "hh_pct_black_lt30ami", "hh_pct_hisp_lt30ami", "hh_pct_ai_pi_lt30ami", "stusab", "state", "state_name", "county", "county_name", "tract"]
...
```{python}
df_il_cleaned["geoid"].value_counts()
print(df_small_rural.columns)
```
